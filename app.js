...
const folder_icon = `<i class="ri-folder-5-line fs-3 text-warning me-1"></i>`
...
const zip_icon = `<i class="ri-folder-zip-line fs-3 text-info me-1"></i>`
...
const file_icon = `<i class="ri-file-list-3-line fs-3 text-warning me-1"></i>`
            ...
            if (item['mimeType'] == 'application/vnd.google-apps.folder') {
                ...
                html += `
                 <a class="countitems size_items list-group-item-action" style="text-decoration: none;" href="${link}">${item.name}</a>
                        ${UI.display_size ? `<span class="badge-dim bg-dark p-1x float-end"> `+ item['size'] + ` </span>` : ``}
